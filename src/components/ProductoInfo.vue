      ...
      <div class="containerProduct">
        ...
        <div class="containerInfo">
          <ul>
            ...
            <li v-if="elemento.cantidad > 5" class="verde">
              Disponibles: {{ elemento.cantidad }} en stock
            </li>
            <li
              v-if="elemento.cantidad <= 5 && elemento.cantidad > 0"
              class="amarillo"
            >
              Disponibles: {{ elemento.cantidad }} en stock
            </li>
            <li v-if="elemento.cantidad == 0" class="rojo">
              Disponibles: {{ elemento.cantidad }} no quedan
            </li>
          </ul>
          <button
            @click="removeFromCart(elemento.id)"
